...
module.exports = {
  up: (queryInterface, Sequelize) => {
   return queryInterface.bulkInsert('Businesses', [
    ...
    {name:"The Woolworth",ownerId:"2",category:"American restaurant",description:"Cozy yet stylish bar with an elevated menu of shared plates & entrees plus handcrafted cocktails.",address:"1520 Elm St",city:"Dallas",state:"TX",zip_code:"75080",phone_number:"8859742531",image:"https://www.brides.com/thmb/-KQTuWOQG7Mok0bnddVwUmbWPEE=/735x0/sq-9993863a7d29451c99bedbc97653cabb.jpg", createdAt: '2019-01-01', updatedAt: '2019-01-01' },
